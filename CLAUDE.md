...
## Current State
Last updated: 2026-05-07 (Week 9 close-out)
...
- `data/evaluation/full_labeled_dataset.jsonl` — 1,200 Haiku-labeled pairs (60 queries × top-20, IDs 0-19, 300-309, 400-429); produced by `scripts/build_full_eval_dataset.py`
